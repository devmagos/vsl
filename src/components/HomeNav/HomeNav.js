...
function HomeNav() {
  return (
    ...
    <Navbar className="navcolor" expand="lg">
        <Navbar.Toggle className="align-toggle" aria-controls="vsl-home-navbar-Navbar" />
        <Navbar.Collapse className="" id="vsl-navbar-Navbar">
          <Navbar className="colornav">
            <NavDropdown title="Services" id="vsl-home-dropdown">
            <NavDropdown.Item href="#action/3.1">
            <Link to="../Services" className="drop">Services</Link>
            </NavDropdown.Item>
            ...
            <Navbar.Text className="colornav"><Link to="../ImmigrationApplication" className="colornav-link">Immigration Applications</Link></Navbar.Text>
