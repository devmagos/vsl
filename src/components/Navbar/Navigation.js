    ...
    <Navbar className="navcolor" expand="lg">
        ...
        <Navbar.Collapse className="" id="vsl-navbar-Navbar">
          <Navbar className="colornav">
            <NavDropdown title="Services" href="../Services" id="vsl-dropdown">
            ...
            <Link to="../Limited" className="drop">Limited</Link>
            </NavDropdown.Item>
            ...
            <Navbar.Text className="colornav"><Link to="../Limited" className="colornav-link">Limited</Link></Navbar.Text>
