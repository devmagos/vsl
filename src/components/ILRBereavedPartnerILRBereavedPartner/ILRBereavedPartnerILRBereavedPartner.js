...
import './ILRBereavedPartnerILRBereavedPartner.css'
...
function ILRBereavedPartnerILRBereavedPartner() {
  return (
                ...
                <Col md="5" className="row g-0 rounded overflow-hidden flex-md-row mb-4 h-125 position-relative">
                  <div class="row g-0 p-4 rounded overflow-hidden flex-md-row mb-4 h-md-250 position-relative">
                    <Col p="5 d-flex flex-column position-static justify-items-justify" className='welcome-text'>
                      <h2 class="color"><strong>ILR – Bereaved Partner ILR – Bereaved Partner</strong></h2>
                      ...
                      <div class="justify-content-justify">
                        <button class="btn p-3 m-1 text-light btncolor btn-sm" type="button"><Link to="../ILRBereavedPartnerILRBereavedPartner" class="nav-link">Contact Us</Link></button>
                        <button class="btn p-3 m-1 text-light btncolor btn-sm" type="button"><Link to="../ILRBereavedPartnerILRBereavedPartner" class="nav-link">Book an Appointment</Link></button>
                      </div>
                    </Col>
                  </div>
                </Col>
...
export default ILRBereavedPartnerILRBereavedPartner;